import ctypes
import sys
from ctypes import POINTER, Structure, c_bool, c_int8, c_size_t
...
def load_lib():
    ...
    lib.hash_set_len.argstype = (
        POINTER(HashSetS),
        POINTER(c_size_t),
    )
    lib.hash_set_len.restype = c_int8

    lib.hash_set_contains.argstype = (
        POINTER(HashSetS),
        POINTER(c_size_t),
        POINTER(c_bool),
    )
    ...
    lib.hash_set_insert.argstype = (
        POINTER(HashSetS),
        c_size_t,
    )
    lib.hash_set_insert.restype = c_bool

    lib.hash_set_collect.argstype = (
        POINTER(HashSetS),
